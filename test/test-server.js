...
describe('Shopping List', function() {
  ...
  it('should list shopping items on GET', function() {
  ...
  it('should add a shopping item on POST', function() {
  ...
  it('should update shopping items on PUT', function() {
  ...
  it('should delete shopping items on DELETE', function() {
    return chai.request(app)
...
describe('Recipes', function() {
  ...
  it('should add a recipe item on POST', function() {
    const newItem = {name: 'delish recipe', ingredients: ['thing1','thing2']};
    return chai.request(app)
      .post('/recipes')
      .send(newItem)
      .then(function(res) {
  ...
  it('should update recipe items on PUT', function() {
    ...
    const updateData = {
      name: 'mediocre recipe',
      ingredients: ['meh','blah']
    };
